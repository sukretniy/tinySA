...
// MOD_type: 2    Rsymb(sps): 100    Fdev(Hz): 1    RXBW(Hz): 200    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
...
// # WB filter 9 (BW =   0.22 kHz);  NB-filter 9 (BW = 0.22 kHz)
// 
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_LIMITER_1_3_1 0x11, 0x20, 0x03, 0x30, 0x01, 0xF8, 0xA0
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x03, 0x00, 0x04, 0x01, 0x00, 0xFF, 0x06, 0x18, 0x10, 0x40
